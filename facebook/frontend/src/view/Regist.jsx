...
export default function Regist(props) {
    ...
    const onClickRegist = () => {
        ...
        if(!userid){return alert("사용자 아이디를 반드시 입력해주세요.")}
        if(!password){return alert("비밀번호를 반드시 입력해주세요.")}
        if(!year){return alert("태어난 년도를 반드시 입력해주세요.")}
        if(!month){return alert("태어난 월을 반드시 입력해주세요.")}
        if(!day){return alert("태어날 일을 반드시 입력해주세요.")}
        if(!gender){return alert("성별을 반드시 입력해주세요.")}
        ...
        <div className="regist-layer">
            ...
            <div className="card">
                ...
                <div className="header">
                    ...
                    <Subtitle className="title" text="빠르고 쉽습니다." />
                </div>
                <Linebar />
                {/* 박스 콘텐츠 */}
                <div className="body">
                    ...
                    <div className="in-type">
                        ...
                        <span>
                            ...
                            <span className="in-rdo">
                                ...
                                <input className="gender" id="rdo-3" type="radio" name="sex" value="3" onClick={()=>setGender("제 3의 성")}  />
                            </span>
                        </span>
                    </div>
                    {/* 하단의 가이드 */}
